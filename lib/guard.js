...
function supabase() {
  ...
  // could run. Tests set GUARD_DURABLE=off; production never does - and now
  // cannot: env-guard refuses it on Vercel production rather than trusting that
  // nobody sets it.
  require('./env-guard').assertDurableGuardSafe();
